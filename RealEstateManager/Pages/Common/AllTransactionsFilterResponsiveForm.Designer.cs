...
{
    partial class AllTransactionsFilterResponsiveForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            groupBoxFilter.Size = new Size(1168, 95);
            ...
            labelType.Size = new Size(125, 19);
            ...
            comboBoxType.Size = new Size(180, 25);
            ...
            dateTimePickerFrom.Size = new Size(170, 25);
            ...
            dateTimePickerTo.Size = new Size(170, 25);
            ...
            buttonFilter.Location = new Point(1039, 34);
            ...
            // 
            // AllTransactionsFilterResponsiveForm
            // 
            ...
            MaximizeBox = false;
            Name = "AllTransactionsFilterResponsiveForm";
            Text = "Filter All Transactions (Responsive)";
        ...
        // Responsive layout for controls based on ClientSize
        protected override void OnResize(EventArgs e)
        {
            base.OnResize(e);
            int margin = 20;
            int filterHeight = 95;
            int resultsHeight = ClientSize.Height - filterHeight - (3 * margin);
            int resultsWidth = ClientSize.Width - (2 * margin);
            groupBoxFilter.Width = ClientSize.Width - (2 * margin);
            groupBoxResults.Width = resultsWidth;
            groupBoxResults.Height = resultsHeight;
            groupBoxResults.Location = new Point(margin, filterHeight + (2 * margin));
            dataGridViewResults.Width = resultsWidth - 30;
            dataGridViewResults.Height = resultsHeight - 40;
            dataGridViewResults.Location = new Point(15, 35);
            // Adjust filter controls
            int filterControlY = 42;
            labelType.Location = new Point(32, filterControlY + 5);
            comboBoxType.Location = new Point(202, filterControlY);
            labelFrom.Location = new Point(400, filterControlY + 5);
            dateTimePickerFrom.Location = new Point(500, filterControlY);
            labelTo.Location = new Point(700, filterControlY + 5);
            dateTimePickerTo.Location = new Point(780, filterControlY);
            buttonFilter.Location = new Point(ClientSize.Width - 220, filterControlY);
        }
    }
}
