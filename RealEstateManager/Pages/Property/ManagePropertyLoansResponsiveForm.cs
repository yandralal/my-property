...
{
    public partial class ManagePropertyLoansResponsiveForm : Form
    {
        private readonly Image _editIcon = Properties.Resources.edit;
        private readonly Image _viewIcon = Properties.Resources.view;
        private readonly Image _deleteIcon = Properties.Resources.delete1;

        public ManagePropertyLoansResponsiveForm()
        {
            InitializeComponent();
            ApplyGridStyle(dataGridViewLoans);
            LoadLoans();
